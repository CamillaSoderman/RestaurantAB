...
//            var swedenZone = TimeZoneInfo.FindSystemTimeZoneById("Europe/Stockholm");
//            var local = TimeZoneInfo.ConvertTimeFromUtc(startTime, swedenZone);

//            // Endast bokningar mellan 10–22
//            if (local.Hour < 10 || local.Hour >= 22)
//                return BadRequest("Bokningar är endast tillåtna mellan 10:00 och 22:00.");

//            var table = await _reservationService.GetBestAvailableTableAsync(local, numberOfGuests);
...
//        // -------------------- UPDATE RESERVATION --------------------
//        //[HttpPut("update/{id}")]
//        //public async Task<IActionResult> UpdateReservation([FromBody] ReservationDTO resDTO, int id)
//        //{
...
//        public async Task<IActionResult> UpdateReservation([FromBody] ReservationUpdateDTO dto, int id)
//        {
//            var updated = await _reservationService.UpdateReservationAsync(id, dto);
